  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/services" className="btn-primary flex items-center gap-2 px-8 py-4 rounded-2xl font-bold shadow-neon group">
                Explore Services <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/portfolio" className="glass hover:bg-white/5 transition-all text-white px-8 py-4 rounded-2xl font-bold border border-white/10 flex items-center gap-2">
                View Portfolio
              </Link>
            </div>
            ...
            <div className="flex items-center gap-8 pt-6 border-t border-white/5">
               <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-gray-500 uppercase font-black tracking-widest">Experience</span>
               </div>
               <div className="flex flex-col">
                  <span className="text-2xl font-black text-white">10k+</span>
                  <span className="text-[10px] text-gray-500 uppercase font-black tracking-widest">Happy Clients</span>
               </div>
               <div className="flex flex-col">
                  <span className="text-2xl font-black text-white">24h</span>
                  <span className="text-[10px] text-gray-500 uppercase font-black tracking-widest">Avg Delivery</span>
               </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative glass border-primary/10 rounded-[40px] p-10 overflow-hidden transform-style-3d group">
                ...
                <div className="relative z-10 grid grid-cols-2 gap-4">
                   <div className="space-y-4">
                      <div className="h-48 glass rounded-3xl border-white/5 flex items-center justify-center p-6 grayscale hover:grayscale-0 transition-all duration-500">
                         <History className="text-primary w-12 h-12" />
                      </div>
                      <div className="h-64 glass rounded-3xl border-white/5 flex flex-col items-center justify-center p-6 space-y-4 group/card">
                         <Layers className="text-blue-400 w-10 h-10 group-hover/card:scale-110 transition-transform" />
                         <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">Multi-layer Restoration</span>
                      </div>
                   </div>
                   <div className="space-y-4 pt-8">
                      <div className="h-64 glass rounded-3xl border-white/5 flex flex-col items-center justify-center p-6 space-y-4 group/card">
                         <ImageIcon className="text-purple-400 w-10 h-10 group-hover/card:scale-110 transition-transform" />
                         <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">High-Res Scanning</span>
                      </div>
                      <div className="h-48 glass rounded-3xl border-white/5 border-primary/20 flex items-center justify-center p-6 group/card">
                         <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover/card:bg-primary group-hover/card:text-black transition-all">
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        <div className="max-w-4xl mx-auto glass p-12 md:p-20 rounded-[50px] border-primary/20 relative z-10 text-center space-y-8 overflow-hidden group">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white leading-none">READY TO BRING <br /> MEMORIES TO <span className="text-primary italic underline decoration-primary/20 underline-offset-8">LIFE?</span></h2>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-4">
               <Link href="/services" className="btn-primary w-full md:w-auto px-12 py-5 rounded-3xl font-black text-xs uppercase tracking-widest shadow-neon">
                  Order Now
               </Link>
