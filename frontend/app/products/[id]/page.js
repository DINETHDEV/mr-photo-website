        ...
        >
          ...
          <div className="glass p-8 rounded-[30px] border-white/5 bg-white/[0.02]">
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
               {product.description || `Enhance your memories with our ${product.name} service. We prioritize quality and precision to ensure every pixel tells your story perfectly. Our team of professionals treats every project with extreme care.`}
            </p>
          </div>
