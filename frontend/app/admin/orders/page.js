    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <div className="flex-grow flex flex-col md:flex-row justify-between gap-4 w-full">
                     ...
                     <div className="flex flex-col items-center md:items-end justify-center gap-2">
                        <span className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest ${
                           order.status === 'Completed' ? 'bg-emerald-400 text-black shadow-neon' : 
                           order.status === 'Processing' ? 'bg-blue-500 text-black shadow-neon' :
                           order.status === 'Cancelled' ? 'bg-red-500 text-black shadow-neon' :
         ...
         <div className={`lg:col-span-4 ${selectedOrder ? 'block' : 'hidden lg:block lg:opacity-30'}`}>
            {selectedOrder ? (
               <GlassCard className="sticky top-10 border-primary/20 sticky-order-detail p-8 space-y-8 animate-in slide-in-from-right duration-300">
                  <div className="flex justify-between items-start">
                     ...
                     <button onClick={() => setSelectedOrder(null)} className="md:hidden p-2 glass rounded-lg"><XCircle size={18}/></button>
                  </div>
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="space-y-4 pt-4 border-t border-white/5">
                        ...
                        <div className="flex items-start gap-4">
                           ...
                           <div>
                              ...
                              <p className="text-sm text-gray-300 italic leading-relaxed font-black">&ldquo;{selectedOrder.message || 'No instructions provided.'}&rdquo;</p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="space-y-4 pt-4 border-t border-white/5">
                        ...
                        {selectedOrder.uploadedImage ? (
                           <div className="relative aspect-video rounded-2xl overflow-hidden glass border-white/10 group">
                              ...
                              >
                                 <span className="p-3 glass rounded-full text-white shadow-neon"><ExternalLink size={20} /></span>
                              </a>
                           </div>
                        ) : (
                     ...
                     <div className="pt-4 border-t border-white/5">
                        <a 
                           ...
                           target="_blank"
                           className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl bg-emerald-500 text-white font-black text-xs uppercase tracking-[3px] shadow-neon hover:scale-105 transition-transform"
                        >
